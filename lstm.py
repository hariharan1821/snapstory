...
df=pd.read_csv("videos.csv",nrows=100000)
...
inp_video = input("Enter : ")
print("video :",inp_video)
inp_video = clean(inp_video,"inputs")
inp_video = ' '.join(inp_video)
inp_x= in_tokenizer.texts_to_sequences([inp_video]) 
